    ...
    class ReviewsController < API::BaseController
        ...
        def index
            ...
            reviews = @parent.reviews
                ...
                .with_rating(params[:rating])
                .sort_by_rating(params[:sort_by_rating])

            reviews = reviews.with_description_only unless params[:with_description_only] == false || params[:with_description_only] == 'false'
